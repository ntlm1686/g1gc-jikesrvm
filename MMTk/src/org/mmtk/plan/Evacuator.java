 ...
 */
@Uninterruptible
public class Evacuator {

  // Global pools for load-balancing deques
  final SharedDeque refugeePool;

  /**
   * @param metaDataSpace the space to use for allocation for this
   *  instance
   */
  public Evacuator(RawPageSpace metaDataSpace) {
    refugeePool = new SharedDeque("refugeePool",metaDataSpace, 1);
  }
  ...
  public void prepareNonBlocking() {
    refugeePool.prepareNonBlocking();
  }
  ...
  public boolean hasWork() {
    return refugeePool.enqueuedPages() > 0;
  }
}
